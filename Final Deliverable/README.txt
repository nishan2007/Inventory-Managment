SmartStock Final Deliverable Package
=======================

This Final Deliverable directory is organized to keep the project deliverables separated by purpose while still including the full application source, a deployable build, database deliverables, and end-user documentation.
